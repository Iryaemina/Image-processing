...
# -------------------------- Page: Contact ----------------------------
    ...
    st.markdown("""
    **Developer:** Logesh B P  
    **Email:** [lb4592@srmist.edu.in](mailto:lb4592@srmist.edu.in)  
    **GitHub:** [Iryaemina](https://github.com/Iryaemina)  
    **LinkedIn:** [Logesh Murugan](https://www.linkedin.com/in/logesh-murugan-41493824b/)
    """)
